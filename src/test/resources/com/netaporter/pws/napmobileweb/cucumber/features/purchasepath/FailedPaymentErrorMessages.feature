Feature: Purchase Path Failed Payment Error Messages Tests

  ################################### START GENERIC ERROR MESSAGE TESTS   ##############################################################

  @ecomm @allChannels @channelSpecific @purchasePath @known-failure
  ...
  @ecomm @region=APAC @channelSpecific @purchasePath @known-failure
  Scenario Outline: The generic payment failure error message is shown to the customer when their payment fails
    Given I am on <channel>
    And I am on change country page
    And I change my country to <country>
  ...
  @ecomm @allChannels @purchasePath @French @known-failure
  ...
  @ecomm @allChannels @purchasePath @German @known-failure
  ...
  @ecomm @allChannels @purchasePath @known-failure
  ...
  the international Givenchy customer care phone number is displayed.
    ...
    And I am on change country page
    And I change my country to <country>
    And I add a product from designer Givenchy to my shopping bag

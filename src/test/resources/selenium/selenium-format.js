/*
 * Format for TheOutnet.com
 * @author Juan Uys <java@net-a-porter.com>
 * @version 0.1
 */
...
function echo(message) {
	return "log.info(" + xlateArgument(message) + ");";
}
...
this.options = {
	receiver: "selenium",
	packageName: "com.netaporter.outnetweb.integrationtests.selenium",

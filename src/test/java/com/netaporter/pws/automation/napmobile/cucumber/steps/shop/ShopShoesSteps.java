...
public class ShopShoesSteps extends BaseNapMobileSteps {

    @Then("^I will be at the shop Shoes page$")
    public void I_will_be_at_the_shop_shoes_page() throws Throwable {
        Assert.assertTrue(
                "Page heading = " + titleMobileComponent.titleMainHeadingText(),
                shopShoesMobilePage.at()
        );
    }
}

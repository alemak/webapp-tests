...
public class ShopMakeupSteps extends BaseNapMobileSteps {

    @Then("^I will be at the shop Makeup page$")
    public void I_will_be_at_the_shop_makeup_page() throws Throwable {
        Assert.assertTrue(
                "Page heading = "
                        + titleMobileComponent.titleMainHeadingText()
                        + " Sub heading = "
                        + titleMobileComponent.titleSubListText(),
                shopMakeupMobilePage.at()
        );
    }
}

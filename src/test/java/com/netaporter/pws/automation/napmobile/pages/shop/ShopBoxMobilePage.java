...
@Component
@Scope("cucumber-glue")
public class ShopBoxMobilePage extends AbstractNapMobilePage {

    private static final String NAME = "Shop Box Mobile";
    private static final String PATH = "Shop/Bags/Clutch_Bags/Box";
    ...
    public boolean at() {
        return titleMobileComponent.titleMainHeadingText().equals("BAGS")
                && titleMobileComponent.titleSubListText().equals("BOX");
    }
}

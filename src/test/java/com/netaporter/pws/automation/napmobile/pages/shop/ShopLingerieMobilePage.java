...
@Component
@Scope("cucumber-glue")
public class ShopLingerieMobilePage extends AbstractNapMobilePage {

    private static final String NAME = "Shop Lingerie Mobile";
    private static final String PATH = "Shop/Lingerie/All";

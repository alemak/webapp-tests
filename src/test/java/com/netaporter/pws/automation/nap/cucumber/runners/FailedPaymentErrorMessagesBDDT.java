...
@CucumberOptions(
        features = "classpath:com/netaporter/pws/nap/cucumber/features/NAPPurch/PurchasePath/FailedPaymentErrorMessages.feature",  tags = "@nap",
...
public class FailedPaymentErrorMessagesBDDT {
}
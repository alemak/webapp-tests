...
@CucumberOptions(
    features = "classpath:com/netaporter/pws/nap/cucumber/features/NAPPurch/PurchasePath/PurchasePathPaymentValidation.feature", tags="@nap",
...
public class PurchasePathPaymentValidationBDDT {
}
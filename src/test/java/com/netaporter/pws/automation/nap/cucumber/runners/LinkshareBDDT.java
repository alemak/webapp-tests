...
/**
 * User: j.wilson@london.net-a-porter.com
 * Date: 13/02/2013
 */

@RunWith(Cucumber.class)
@CucumberOptions(features = "classpath:com/netaporter/pws/nap/cucumber/features/PurchasePath/Linkshare.feature", tags = "@nap",

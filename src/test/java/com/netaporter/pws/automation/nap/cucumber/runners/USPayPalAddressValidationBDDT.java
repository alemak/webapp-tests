...
@CucumberOptions(
        features = "classpath:com/netaporter/pws/nap/cucumber/features/NAPPurch/PurchasePath/USPayPalAddressValidation.feature",
...
public class USPayPalAddressValidationBDDT {
}
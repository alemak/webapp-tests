...
/**
 * Created by ocsiki on 10/01/2014.
 */
@RunWith(Cucumber.class)
@CucumberOptions(features = "classpath:com/netaporter/pws/nap/cucumber/features/UpdateCountry/ChannelBouncing.feature", tags = "@nap",
...
public class ChannelBouncingBDDT {
}
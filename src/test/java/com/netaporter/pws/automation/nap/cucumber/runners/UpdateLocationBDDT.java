...
/**
 * Created by ocsiki on 09/12/14.
 */
@RunWith(Cucumber.class)
@CucumberOptions(features = "classpath:com/netaporter/pws/nap/cucumber/features/NAPPurch/Account/UpdateLocation.feature", tags = "@nap",
...
public class UpdateLocationBDDT {
}
...
/**
 * Created by s.joshi on 02/09/2014.
 */
@RunWith(Cucumber.class)
@CucumberOptions(features = "classpath:com/netaporter/pws/nap/cucumber/features/Girdle/Girdle.feature", tags = "@girdleSanity",
